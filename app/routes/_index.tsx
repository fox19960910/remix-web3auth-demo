...
const clientId =
  "BGtzPc7cLgAEsHDvHUz0a-zFpkh-q-PfGUVGqQB0bsoVtTd4SPdgmJ4fNqQDuhLIcCcC2sxqJV_VLLo4b5IoOgo"; // get from https://dashboard.web3auth.io
  ...
  return (
    <div className="container">
      ...
      <footer className="footer">
        <a
          href="https://github.com/Web3Auth/examples/tree/main/web-no-modal-sdk/polkadot/nextjs-polkadot-modal-example"
          target="_blank"
